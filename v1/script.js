...
async function loadFacts() {
  const res = await fetch(
    "https:/zkjasonpoplzxkevvafj.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpramFzb25wb3BsenhrZXZ2YWZqIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzY2Mzc3ODAsImV4cCI6MTk5MjIxMzc4MH0.os4sz2d14lVSj1u9ZMteKo7Ks9V6hmRnV0OgGp9-vP8",
      },
    }
  );
...
// factsList.insertAdjacentHTML("afterbegin", "<li>Anand</li>");
...
if (votesInteresting === votesMindblowing) {
  alert("This fact is equallt interesting and mindblowing");
...
function calcFactAge(year) {
  ...
  if (age >= 0) return age;
    ...
    return `Impossible year. Year needs to be equal or less than ${currentYear}`;
}
